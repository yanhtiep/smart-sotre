...
<body>
    ...
    <div class="lg-container">
        ...
        @endif
        <form action="{{url('/user/register')}}" id="lg-form" name="lg-form" method="post">
            ...
            <div>
                ...
                <input class="password" type="password" name="password" id="password" aria-describedby="basic-addon1" placeholder="password"  />
                {!! $errors->first('password', '<div class="help-block col-xs-12 col-sm-reset inline error" style="color:#ff5a92;">:message</div>') !!}
            </div>
            <div>
                <label for="password">Confirm Password :</label>
                <input class="forms password" type="password" name="confpassword" id="confpassword" aria-describedby="basic-addon1" placeholder="confirm password"  />
