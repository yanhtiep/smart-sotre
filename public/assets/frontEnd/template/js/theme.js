		...
		if($(this).is(':appeared')){
			if (con < t) {
				$.ajax({
		            ...
		            data:{'cateId':rel},
		            success:function(data) {
		            	// $.getScript("/assets/frontEnd/template/js/jquery-1.12.0.min.js");
		            	// $.getScript("/assets/frontEnd/template/js/owl.carousel.js");
		            	// $(cateThis).closest('.category-product-featured').find("#blog").html(data);
		            	// alert("Test");
		            }
		        })
				con = t;
